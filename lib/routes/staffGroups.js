...
Router.route('/staff-groups/:slug/posts', {
	...
	waitOn() {
		return [Meteor.subscribe('teamSpecific', (this.params.slug)),
			Meteor.subscribe('TeamUsers', (this.params.slug)),
...
Router.route('/staff-groups/:slug/announcements', {
	...
	waitOn() {
		return [Meteor.subscribe('teamSpecific', (this.params.slug)), Meteor.subscribe('TeamUsers', (this.params.slug)), Meteor.subscribe('allAnnouncements')];
	},
...
Router.route('/staff-groups/:slug/edit', {
	...
	waitOn() {
		return [Meteor.subscribe('teamSpecific', (this.params.slug)), Meteor.subscribe('staffUsersBasic')];
	},
