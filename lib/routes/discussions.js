Router.route('/discussions', {
	...
	waitOn() {
		...
		return [Meteor.subscribe('tagsFilterInfo'), Meteor.subscribe('questionsBasicInfo'), Meteor.subscribe('questionUsers')];
...
Router.route('/discussions/:slug', {
	...
	waitOn() {
		return [Meteor.subscribe('questionData', this.params.slug), Meteor.subscribe('questionUsers')];
	},
