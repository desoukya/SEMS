...
Router.route('/', {
	...
	waitOn() {
		...
		return [Meteor.subscribe('usersBasic'), Meteor.subscribe('newsFeedSpecific', (Meteor.userId())), Meteor.subscribe('questionsNewsFeed'), Meteor.subscribe('tagsType'), Meteor.subscribe('allAnnouncements'), Meteor.subscribe('posts'), Meteor.subscribe('teams')];
	},
