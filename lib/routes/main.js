...
Router.route('/', {
	...
	waitOn() {
		...
		return [Meteor.subscribe("teamBasicInfo"), Meteor.subscribe('usersBasic'), Meteor.subscribe('newsFeedSpecific', (Meteor.userId())), Meteor.subscribe('questions'), Meteor.subscribe('tagsType'), Meteor.subscribe('allAnnouncements')];
	},
