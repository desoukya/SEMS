Router.route('/announcement/manage', {
	...
	waitOn() {
		return [Meteor.subscribe('allAnnouncements'), Meteor.subscribe('teams'), Meteor.subscribe('usersBasic')];
	},
...
Router.route('/teams/:slug/announcements', {
	...
	waitOn() {
		return [Meteor.subscribe('teamSpecific', (this.params.slug)), Meteor.subscribe('announcements')];
	},
...
Router.route('/teams/:slug/milestones', {
	...
	waitOn() {
		return [Meteor.subscribe('teamSpecific', (this.params.slug)), Meteor.subscribe('milestones')];
	},
